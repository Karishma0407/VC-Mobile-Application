...
public class WaxingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_waxing, container, false);
        ...
        Spinner spinner = (Spinner) v.findViewById(R.id.spinner_waxing_services);
        // Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(
                getActivity(),
                R.array.spinner_array_waxing_services,
        ...
        videoView.setVideoPath("android.resource://" +  getContext().getPackageName() + "/" + R.raw.waxingvideo);
